...
# Remove the automatic device selection and model loading at module level
# This will be handled by the Streamlit app instead
...
# Function to get device (utility function)
def get_device():
    return torch.device(
...
# Function to make a prediction on a single image (keep for backward compatibility)
